...
export default function SixthPage() {
  return (
    <div className=" max-lg:pt-[1700px] max-md:pt-[1800px] border-none max-xl:pt-[300px]  flex justify-center flex-col items-center text-black h-screen w-screen max-lg:bg-gray-100 bg-white">
      ...
      <div className="flex grid grid-cols-4 mb-24 max-lg:ml-12 ml-6 max-md:ml-6">
        ...
        <div className="flex relative">
          ...
          >
            ...
            <p className="font-normal text-[20px]  ml-6 mt-6 max-sm:absolute max-sm:bottom-3 max-sm:top-[70px] max-sm:right-[60px]  text-[12px] text-gray-700 dark:text-gray-400 max-lg:ml-4">
              Hours
            </p>
          </a>
          <div className="pt-28 px-4">
        ...
        <div className="flex relative">
          ...
          >
            ...
            <p className="font-normal text-[20px] max-sm:absolute max-sm:bottom-3 max-sm:top-[70px] max-sm:right-[50px]  ml-4 mt-6 text-gray-700 text-[12px] dark:text-gray-400 max-lg:ml-2">
              Minutes
            </p>
          </a>
          <div className="pt-28 px-4">
        ...
        <div className="flex relative">
          ...
          >
            ...
            <p className="font-normaltext-gray-700   text-[12px] dark:text-gray-400 mt-2 text-[20px] ml-8 mt-6 text-gray-700 text-[12px] dark:text-gray-400 max-sm:absolute max-sm:bottom-3 max-sm:top-[70px] max-sm:right-[50px] max-lg:ml-2">
              Seconds
            </p>
          </a>
        </div>
