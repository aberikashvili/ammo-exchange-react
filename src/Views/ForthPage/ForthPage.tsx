...
export default function ForthPage() {
  ...
  return (
    <div className="flex justify-center items-center max-lg:pt-[1430px]  text-black  h-screen w-screen bg-white">
      <div className="w-[1536px] max-sm:w-[640px] max-md:w-[768px] max-lg:w-[1024px] max-xl:[1280px]  s4:w-[375] max-s1:w-[500px] max-s2:w-[400px] max-s3:w-[375px] max-s4:w-[350px]   h-[800px] px-14 rounded-3xl	 shadow bg-gray-100 mx-auto p-4  text-center ">
        <div className="w-full">
          ...
          <div className=" flex justify-between items-center ">
            <section className="w-full flex justify-start ">
              <div className="w-ful flex gap-[55px] items-start">
                <ul>
                  <li
                    onClick={() => setImg(1)}
                    className=" max-xl:mt-[400px] max-sm:ml-8 max-xl:ml-[330px] max-lg:mt-[430px]  max-lg:ml-[210px] max-md:ml-[100px] max-md:mt-[390px] block w-[480px] rounded-[10px] border-solid border-[1px] border-[gray] flex flex-col flex-start justify-start items-start text-start px-[25px] pt-4 pb-4 gap-[10px] relative"
                  >
            ...
            <div className="absolute right-12 top-[340%] max-xl:w-[550px] max-xl:mr-[330px]  max-sm:ml-0 max-sm:mr-[70px] max-s1:ml-4 max-s1:mr-0  max-lg:mr-[190px]   max-lg:mt-[1000px]  block w-[730px] max-md:w-[400px] max-md:mr-32  ">
